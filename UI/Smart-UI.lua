...
local Library do 
    ...
    local oldUI, _oldUI = parent:FindFirstChild("QYRIX"), parent:FindFirstChild("_QYRIX")

    if oldUI and _oldUI then
        oldUI:Destroy()
        _oldUI:Destroy()
    end
    ...
    local Instances = { } do
        ...
        Instances.Get = function(self, Item)
    ...
    do 
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["OpenButton"] = Instances:Create("ImageButton", {
                    ...
                    BorderSizePixel = 0,
                    Position = UDim2.new(0.504977405, 0, 0.0858930126, 0),
                    Size = UDim2.new(0, 28, 0, 28),
                    Image = "rbxassetid://116342860199829"
                }) Items["OpenButton"]:MakeDraggable()

                Items["OpenButton_UICorner"] = Instances:Create("UICorner", {
                    Parent = Items["OpenButton"].Instance,
                    Name = "\0",
                    CornerRadius = UDim.new(0, 3)
                })

                Global["USE_MENU_BUTTON"] = true

                Items["OpenButton"]:Connect("MouseButton1Up", function()
            ...
            function Window:SetOpen(Bool)
                ...
                Global["GUI_TOGGLED"] = Bool

                Window.IsOpen = Bool

                Debounce = true 
                
                -- Items["OpenButton"].Instance.Visible = Global["USE_MENU_BUTTON"] and not Bool or false
                Items["OpenButton"]:Tween(TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {ImageTransparency = (Global["USE_MENU_BUTTON"] and not Bool) and 0 or 1})
        ...
        Library.Pages.Section = function(self, Data) -- [[_SECTION]]
            Data = Data or { }
            ...
            local Items = { } do
                ...
                Items["Content"] = Instances:Create("Frame", { -- [[_Content]]
                    Parent = Items["Background"].Instance,
                    Name = "\0",
                    BorderColor3 = FromRGB(0, 0, 0),
                    BackgroundTransparency = 1,
        ...
        Library.Sections.Textbox = function(self, Data) -- [[_TEXTBOX]]
            Data = Data or { }
        ...
        Library.Sections.Listbox = function(self, Data)
            ...
            local Items = { } do 
                local ListBoxSize = 200 --or Dropdown.Size
                Items["Listbox"] = Instances:Create("Frame", {
                    Parent = Dropdown.Section.Items["Content"].Instance,
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(1, 0, 0, ListBoxSize),
                    BorderColor3 = FromRGB(0, 0, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                ...
                Items["Background_UIStroke"] = Instances:Create("UIStroke", {
                    Parent = Items["Background"].Instance,
                    Name = "\0",
                    Color = FromRGB(150, 150, 150),
                    ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                ...
                Instances:Create("UIGradient", {
                    Parent = Items["Background_UIStroke"].Instance,
                    Name = "\0",
                    Enabled = true,
                    Rotation = -115,
                    Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 255, 255)), RGBSequenceKeypoint(1, FromRGB(143, 143, 143))}
                ...
                Instances:Create("UIListLayout", { --[[ListBoxListLayout]]
                    Parent = Items["Listbox"].Instance,
                    Name = "ListBoxListLayout",
                    Padding = UDimNew(0, 4),
                    SortOrder = Enum.SortOrder.LayoutOrder
                })
            ...
            ConfigsSection:Button({
                ...
                Callback = function()
                    ...
                    if InputName and InputName ~= "" then
                        ...
                        Library:Save(Library.Folders.Configs .. "/" .. FinalName, Library:GetConfig())
                ...
                Callback = function()
                    if ConfigSelected and isfile(Library.Folders.Configs .. "/" .. ConfigSelected) then
                        ...
                        Library:Notify({
                            Title = "Config",
                            Duration = 5,
                            Description = "Deleted "..ConfigSelected.."!",
                            Gradient = {
                                Color1 = Library.Theme.Accent,
                                Color2 = Library.Theme.AccentGradient,
                            }
                ...
                Callback = function()
                    if ConfigSelected and isfile(Library.Folders.Configs .. "/" .. ConfigSelected) then
                        ...
                        Library:Notify({
                            Title = "Config",
                            Duration = 5,
                            Description = "Loaded "..ConfigSelected.."!",
                            Gradient = {
                                Color1 = Library.Theme.Accent,
                                Color2 = Library.Theme.AccentGradient,
                            }
            ...
            ConfigsSection:Button({
                ...
                Callback = function()
                    if ConfigSelected and isfile(Library.Folders.Configs .. "/" .. ConfigSelected) then
                        ...
                        Library:Save(Library.Folders.Configs .. "/" .. ConfigSelected, Library:GetConfig())
                        Library:SetAutoLoad(AutoLoad_Toggle)
                        Library:SetLastLoadedConfig(ConfigSelected)

                        Library:Notify({
                            Title = "Config",
                            Duration = 5,
                            Description = "Saved "..ConfigSelected.."!",
                            Gradient = {
                                Color1 = Library.Theme.Accent,
                                Color2 = Library.Theme.AccentGradient,
                            }
