...
local function GetShortKey(keyCode)
	local keyName = typeof(keyCode) == "EnumItem" and keyCode.Name or tostring(keyCode)

	if ShortKeys[keyName] then
		return ShortKeys[keyName]
	end
...
function Neverlose_Main:PlaySound(SoundID)
    ...
    sound.Volume = Neverlose_Main.Lib_Sounds.SoundVolume
    sound:Play()
end
...
local function StrokeAdd_Tween(NewParent, Transparency)
    local Transparency = Transparency or 0.8
    local UIStroke = Instance.new("UIStroke")
    spawn(function()
        while task.wait() do
            pcall(function()
                UIStroke.Color = Neverlose_Main.Theme.Custom.Element
            end)
        end
    end)
    ...
    UIStroke.Parent = NewParent
    UIStroke.Color = Neverlose_Main.Theme.Custom.Element

    NewParent.MouseEnter:Connect(function()
        TweenService:Create(
            UIStroke,
            TweenInfo.new(.3, Enum.EasingStyle.Quad),
            {Transparency = 0.1}
    ...
    NewParent.MouseLeave:Connect(function()
        TweenService:Create(
            UIStroke,
            TweenInfo.new(.3, Enum.EasingStyle.Quad),
...
--[[TextSizeConstraint(object, {
    Max = 13,
    Min = 1
})]]
function TextSizeConstraint(object, option)
    local Max, Min = option.Max or 13, option.Min or 1
    local TextSizeConstraint = Instance.new("UITextSizeConstraint")
    TextSizeConstraint.MaxTextSize = Max
    TextSizeConstraint.MinTextSize = Min
    TextSizeConstraint.Parent = object
...
function Neverlose_Main:Window(config)
    local FirstTab, SettingsToggled = false
    ...
    function Neverlose_Main:Notify(cfg)
        ...
        NotifyFrame.Size = UDim2.new(0, 0, 0, 67)
        ...
        spawn(function()
            ...
            if AutoClose then
                ...
                repeat task.wait() until NotifyFrame.Size == UDim2.new(0, 0, 0, 0)
    ...
    function TabsSec:TSection(title)
        ...
        function Neverlose_Main:LoadCfg(cfg)
            ...
            local JSONData = Neverlose_Main.HttpService:JSONDecode(Encoded)
        ...
        function Neverlose_Main:GetDataCFG(cfg)
            local Data = {}
            local Encoded = readfile(Folder1 .. "/configs/" .. cfg .. ".txt")
        ...
        function Neverlose_Main:SaveCfg(cfg)
            ...
            local Encoded = Neverlose_Main.HttpService:JSONEncode(content)
        ...
        function Neverlose_Main:Edit_LastLoad(cfg)
            if not isfolder(Folder1) then return end
        ...
        SaveCFGB.MouseButton1Click:Connect(function()
            if Neverlose_Main.Targeted_Config == "" then
                ...
                Neverlose_Main:Edit_LastLoad(tostring(Neverlose_Main.Targeted_Config))
            end
        end)
        ...
        function Tabs:Tab(title)
            ...
            function Sections:Section(title)
                ...
                function Elements:Text(title)
                    ...
                    Label.BackgroundColor3 = Color3.fromRGB(43, 67, 118)
                    Label.BackgroundTransparency = 1.000
                    Label.BorderColor3 = Color3.fromRGB(0, 0, 0)
                    Label.BorderSizePixel = 0
                    Label.Position = UDim2.new(0.0381034054, 0, 0.327935219, 0)
                    Label.Size = UDim2.new(0, 274, 0, 26)
                    Label.Font = Enum.Font.Gotham
                    Label.Text = ""
                    Label.TextColor3 = Color3.fromRGB(255, 255, 255)
                    Label.TextSize = 14.000

                    StrokeAdd_Tween(Label, 0)
                    ...
                    LabelTitle.Position = UDim2.new(0.0355987065, 0, 0.233333334, 0)
                    LabelTitle.Size = UDim2.new(0, 49, 0, 15)
                    ...
                    spawn(function()
                        while task.wait() do
                            pcall(function()
                                ChangeTypeText(LabelTitle)
                            end)
                        end
                    end)

                    function Labelfunc:Update(New_Text)
                        LabelTitle.Text = New_Text
                    end
                ...
                function Elements:Toggle(title, callback)
                    ...
                    ToggleFrame.Position = UDim2.new(0.84, 0, 0.233333334, 0)
                    ...
                    ToggleDotCorner.CornerRadius = UDim.new(3, 0)
                ...
                function Elements:Dropdown(title, list, callback)
                    ...
                    DropdownFrame.Position = UDim2.new(0.6, 0, 0.233333334, 0)
                    ...
                    DropdownFrameHold.BackgroundColor3 = Color3.fromRGB(255,255,255)
                    ...
                    spawn(function()
                        for i,v in pairs(list) do
                            ...
                            Item.Size = UDim2.new(0.9, 0, 0, 20)
                            ...
                            DropdownHolder.CanvasSize = UDim2.new(0, 0, 0, DropdownHolderLayout.AbsoluteContentSize.Y + 50)
                ...
                function Elements:Checklist(title,glob,list,callback)
                    ...
                    dropfunc.Value = checklists[glob].Value
                    ...
                    Checklist.Name = title
                    Checklist.Parent = Section
                    Checklist.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    Checklist.BackgroundTransparency = 1.000
                    Checklist.BorderColor3 = Color3.fromRGB(0, 0, 0)
                    Checklist.BorderSizePixel = 0
                    Checklist.Position = UDim2.new(0.0171875004, 0, 0, 0)
                    Checklist.Size = UDim2.new(0, 274, 0, 26)
                    Checklist.AutoButtonColor = false
                    Checklist.Font = Enum.Font.SourceSans
                    Checklist.Text = ""
                    Checklist.TextColor3 = Color3.fromRGB(0, 0, 0)
                    Checklist.TextSize = 14.000

                    StrokeAdd_Tween(Checklist, 1)
                    ...
                    ChecklistTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    ChecklistTitle.BackgroundTransparency = 1.000
                    ChecklistTitle.BorderColor3 = Color3.fromRGB(0, 0, 0)
                    ChecklistTitle.BorderSizePixel = 0
                    ChecklistTitle.Position = UDim2.new(0.0355987065, 0, 0.233333334, 0)
                    ChecklistTitle.Size = UDim2.new(0.87, 0, 0, 15)
                    ChecklistTitle.Font = Enum.Font.Gotham
                    ChecklistTitle.Text = title
                    ChecklistTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
                    ChecklistTitle.TextSize = 13.000
                    ChecklistTitle.TextXAlignment = Enum.TextXAlignment.Left
                    ChecklistTitle.TextScaled = true

                    TextSizeConstraint(ChecklistTitle, {
                        Max = 13,
                        Min = 1
                    })
                    
                    
                    ChecklistCorner.CornerRadius = UDim.new(0, 4)
                    ...
                    ChecklistArrow.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    ChecklistArrow.BackgroundTransparency = 1.000
                    ChecklistArrow.BorderColor3 = Color3.fromRGB(0, 0, 0)
                    ChecklistArrow.BorderSizePixel = 0
                    ChecklistArrow.Position = UDim2.new(0.899999976, 0, 0.200000003, 0)
                    -- ChecklistArrow.Position = UDim2.new(0.790000021, 0, -0.13333334, 0)
                    ChecklistArrow.Size = UDim2.new(0, 18, 0, 18)
                    ChecklistArrow.Image = "http://www.roblox.com/asset/?id=6034818372"

                    spawn(function()
                        while task.wait() do
                            pcall(function()
                                ChangeTypeText(ChecklistTitle)
                                ChecklistArrow.ImageColor3 = Neverlose_Main.Theme.Custom.Element
                            end)
                        end
                    end)

                    -- ChecklistFrame.Name = title
                    ...
                    ChecklistFrame.Name = title
                    ChecklistFrame.Parent = Section
                    ChecklistFrame.BackgroundColor3 = Color3.fromRGB(3, 5, 13)
                    ChecklistFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
                    ChecklistFrame.BorderSizePixel = 0
                    ChecklistFrame.Position = UDim2.new(0.640705884, 0, 0.233333334, 0)
                    ChecklistFrame.Size = UDim2.new(0, 100, 0, 15)
                    ChecklistFrame.Visible = false
                    ...
                    ChecklistItemLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
                    ...
                    function dropfunc:Set(values)
                        print("Not a Tabel!")
                        if typeof(values) ~= "table" then print("Not a Tabel!") return end

                        -- Clear state
                        table.clear(checklists[glob].Value)

                        -- Reset all visuals
                        for _, item in pairs(checklists[glob].Items) do
                            item.Check.Image = "rbxassetid://6031068420"
                        end

                        -- Apply config values
                        for _, v in ipairs(values) do
                            if checklists[glob].Items[v] then
                                table.insert(checklists[glob].Value, v)
                                checklists[glob].Items[v].Check.Image = "rbxassetid://6031068421"
                            end
                        end

                        table.foreach(checklists[glob], print)
                        print("#######")
                        table.foreach(values, print)

                        ChecklistTitle.Text = title .. " - " .. table.concat(checklists[glob].Value, ", ")
                        return pcall(callback, checklists[glob].Value)
                    end
                    ...
                    Checklist.MouseButton1Click:Connect(
                        function()
                            if DropToggled == false then
                                ...
                                repeat
                                task.wait()
                                until ChecklistFrame.Size == UDim2.new(0, 257, 0, 0)
                                DropToggled = false
                                ChecklistFrame.Visible = false
                                Section.Size = UDim2.new(0, 285, 0, SectionLayout.AbsoluteContentSize.Y + 10)
                                Container.CanvasSize = UDim2.new(0, 0, 0, Container.CanvasSize.Y.Offset + UniNum)
                    ...
                    local function createItem(value)
                        ...
                        checklists[glob].Items[value] = {
                            Button = ChecklistItem,
                            Check = ChecklistItemCheck
                        }

                        ChecklistItem.Name = value
                        ChecklistItem.Parent = ChecklistHolder
                        ChecklistItem.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                        ChecklistItem.BackgroundTransparency = 1.000
                        ChecklistItem.BorderColor3 = Color3.fromRGB(0, 0, 0)
                        ChecklistItem.BorderSizePixel = 0
                        ChecklistItem.Size = UDim2.new(0.9, 0, 0, 20)
                        ChecklistItem.Font = Enum.Font.Gotham
                        ChecklistItem.Text = value
                        ChecklistItem.TextColor3 = Color3.fromRGB(255, 255, 255)
                        ChecklistItem.TextSize = 14
                        ChecklistItem.TextXAlignment = Enum.TextXAlignment.Left

                        StrokeAdd_Tween(ChecklistItem, 1)
                    
                        ChecklistItemCorner.Name = "ChecklistItemCorner"
                        ChecklistItemCorner.Parent = ChecklistItem
                        ChecklistItemCorner.CornerRadius = UDim.new(0, 2)
                        ...
                        ChecklistItemCheck.Size = UDim2.new(0, 20, 0, 20)
                        ChecklistItemCheck.Image = "rbxassetid://6031068420"
                        ChecklistItemCheck.ImageColor3 = Color3.fromRGB(117,161,255)

                        ChecklistItem.MouseEnter:Connect(function()
                            TweenService:Create(
                                ChecklistItem,
                                TweenInfo.new(.2, Enum.EasingStyle.Quad),
                        ...
                        ChecklistItem.MouseLeave:Connect(function()
                            TweenService:Create(
                                ChecklistItem,
                                TweenInfo.new(.2, Enum.EasingStyle.Quad),
                        ...
                        ChecklistItem.MouseButton1Click:Connect(function()
                            local index = table.find(checklists[glob].Value,value)
                            if index then
                                table.remove(checklists[glob].Value,index)
                                ChecklistItemCheck.Image = "rbxassetid://6031068420"
                            else
                                table.insert(checklists[glob].Value,value)
                                ChecklistItemCheck.Image = "rbxassetid://6031068421"
                            end

                            ChecklistTitle.Text = title.." - "..table.concat(checklists[glob].Value,", ")
                            pcall(callback,checklists[glob].Value)
                        end)
                    end
                    ...
                    for i, v in next, list do
                        ...
                        --         {ImageTransparency = 1}
                        --         ):Play()
                        --         repeat task.wait() until ChecklistItemCheck.ImageTransparency == 1
                        --         ChecklistItemCheck.Image = "rbxassetid://6031068421"
                        --         TweenService:Create(
                        --         ChecklistItemCheck,
                        --         TweenInfo.new(.3, Enum.EasingStyle.Quad),
                    ...
                    function dropfunc:Add(toadd)
                        ...
                        ChecklistItem.MouseButton1Click:Connect(function()
                            local index = table.find(checklists[glob].Value, v)
                ...
                function Elements:Slider(title, min, max, start, callback)
                    ...
                    SliderCorner.Name = "SliderDotCorner"
                    SliderCorner.Parent = Slider

                    StrokeAdd_Tween(Slider, 1)
                    ...
                    SliderDotCorner.CornerRadius = UDim.new(3, 0)
                ...
                function Elements:Colorpicker(title, preset, callback)
                    local Colorpickerfunc, CToggled = {Value = nil}, false
                    ...
                    -- local preset = preset or Color3.fromRGB(100, 100, 100)
                    ...
                    function Colorpickerfunc:TextToRGB(text)
                    ...
                    function Colorpickerfunc:Set(val)
                        -- print(Colorpickerfunc:TextToRGB(Colorpickerfunc.Value))
                        Colorpickerfunc.Value = tostring(val)
                        Colorpreview.BackgroundColor3 = Colorpickerfunc:TextToRGB(Colorpickerfunc.Value)
                        ColorValue.Text = Colorpickerfunc:GetFromRGBText(Colorpreview.BackgroundColor3)
                        HueSelection.Position = UDim2.new(0.48, 0, 1 - select(1, Color3.toHSV(Colorpreview.BackgroundColor3)))
                    ...
                    Colorpicker.MouseEnter:Connect(
                     ...
                     Colorpicker.MouseLeave:Connect(
                        ...
                        local function UpdateColorPicker(value)
                            if value then
                                Colorpreview.BackgroundColor3 = value
                                ChoseColor.BackgroundColor3 = value
                                ColorValue.Text = Colorpickerfunc:GetFromRGBText(Colorpreview.BackgroundColor3)
                ...
                function Elements:Bind(title, callback, external)
                    ...
                    BindTitle.TextColor3 = Neverlose_Main.Theme.Custom.Text
                    ...
                    BindFrame.Position = UDim2.new(0.75, 0, 0.200000003, 0)
                    ...
                    local BindTitle = Instance.new("TextLabel")
                    -- local BindKeyFrame = Instance.new("Frame")
                    ...
                    BindFrameCorner.CornerRadius = UDim.new(0, 8)
                    ...
                    AddBind.BackgroundColor3 = Color3.fromRGB(40,40,100)
                    AddBind.BackgroundTransparency = 1
                    ...
                    AddBind.Size = UDim2.new(0, 22, 0, 22)
                    ...
                    AddBindImage.Position = UDim2.new(-0.45, 0, 0.150000006, 0)
                    ...
                    AddBind.MouseButton1Click:Connect(function()
                        ...
                        BindSetting.TextScaled = true

                        TextSizeConstraint(BindSetting, {
                            Max = 14,
                            Min = 1
                        })
                        ...
                        BindKey.Size = UDim2.new(0, 160, 0, 29)
                        ...
                        StrokeAdd_Tween(BindKey, 1)

                        BindKeyCorner.CornerRadius = UDim.new(0, 3)
                        ...
                        BindKeyFrame.Position = UDim2.new(0.649999976, 0, 0.200000003, 0)
                        ...
                        -- BindKeyFrameText.Text = GetShortKey(KeyCodeToText(key))
                        ...
                        TextSizeConstraint(BindKeyFrameText, {
                            Max = 14,
                            Min = 1
                        })
                        ...
                        BModeToggle.MouseButton1Click:Connect(function()
                            ...
                            BindSetting.Text = 'Toggle ('..GetShortKey(BindKeyFrameText.Text)..')'
                            BModeStroke.Parent = BModeHold
                            WhatIsToggled = true
                        end)
                        ...
                        BModeHold.MouseButton1Click:Connect(function()
                            ...
                            BindSetting.Text = 'Hold ('..GetShortKey(BindKeyFrameText.Text)..')'
                            WhatIsToggled = false
                        end)
                        ...
                        BindKey.MouseButton1Click:Connect(function()
                            ...
                            BindKeyFrameText.Text = GetShortKey(a.KeyCode.Name)
                            key = a.KeyCode
                            -- BindText.Text = KeyCodeToText(key)
                    ...
                    for i,v in pairs(external) do
                        ...
                        spawn(function()
                            while task.wait() do
                                BindTitle.TextColor3 = Neverlose_Main.Theme.Custom.Text
                                ModeTitle.TextColor3 = Neverlose_Main.Theme.Custom.Text
                            end
                        end)
                    ...
                    BindSetting.MouseButton1Click:Connect(function()
                        ...
                        if WhatIsToggled == false then
                            ...
                            BModeStroke.Parent = BModeToggle
                            BindSetting.Text = 'Hold ('..GetShortKey(KeyCodeToText(key))..')'
                        else
                            TweenService:Create(
                                BModeToggle,
                                TweenInfo.new(.3, Enum.EasingStyle.Quad),
                            ...
                            BindSetting.Text = 'Toggle ('..GetShortKey(KeyCodeToText(key))..')'
                            BModeStroke.Parent = BModeHold
                        end
                        ...
                        BindKey.MouseButton1Click:Connect(function()
                            ...
                            key = a.KeyCode
                            if WhatIsToggled == false then
                                BindSetting.Text = 'Hold ('..GetShortKey(KeyCodeToText(v.key))..')'
                            else
                                BindSetting.Text = 'Toggle ('..GetShortKey(KeyCodeToText(v.key))..')'
                            end
                            Bind_.Binding = false
                        end)
                        ...
                        BindKeyFrameText.Text = GetShortKey(v.key.Name)
                        ...
                        BindText.Text = GetShortKey(KeyCodeToText(v.key))
                    end
    ...
    spawn(function()
        ...
        local Sec4 = Configs:Section("Misc")
        ...
        local Lib_Sounds = Sec4:Slider("Lib Sounds", 0, 100, 0, function(t)
            Neverlose_Main.Lib_Sounds.SoundVolume = t
        end)

        Neverlose_Main:Notify({
            Title = "Welcome",
            Text = "Menu Key | RightControl",
            Time = 2
        })
